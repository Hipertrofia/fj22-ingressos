...
public class GerenciadorDeSessao {
	...
	public GerenciadorDeSessao(List<Sessao> sessoesDaSala) {
		this.sessoesDaSala = this.sessoesDaSala;
	}
	...
	private boolean terminaAmanha(Sessao sessao) {
		...
		LocalDateTime terminoSessaaoNova = getTerminoSessaoComDiaDeHoje(sessao);
	...
	private boolean horarioIsConflitante(Sessao sessaoExistente, Sessao sessaoNova) {
		...
		LocalDateTime inicioSessaoNova = getTerminoSessaoComDiaDeHoje(sessaoNova);
